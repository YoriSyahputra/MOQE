    ...
    class TicketController extends Controller
    {
        ...
        private function validateTicketData(Request $request)
        {
            return $request->validate([
                ...
                'jenis_QE' => 'required|string|in:QE_RELOK,QE_PREVENTIF',
        ...
        private function generateTicketId()
        {
            ...
            return 'INK' . str_pad($nextId, 8, '0', STR_PAD_LEFT);
        }
        ...
        private function deleteFile(?string $path)
        {
            ...
            return redirect()->route('ticket.dashboard')->with('success', 'Ticket delete successfully.'); 
        }
        ...
        public function getDetails(Ticket $ticket, Request $request)
        {
            ...
            switch ($column) {
                ...
                case 'pelapor':
                    ...
                    break;
                case "no_telepon":
                    $details = "No telepon pelapor: {$ticket->no_telepon}<br>No telepon pelapor: {$ticket->no_telepon}";
                    break;
